...
const ResultadosCalificaciones = () => {
  ...
  const cargarCarreras = async () => {
    try {
      ...
      const response = await fetch('http://localhost/WebServices/obtenerCarreras.php');
...
const cargarCuatrimestres = async () => {
    if (carreraSeleccionada) {
      try {
        const response = await fetch('http://localhost/WebServices/obtenerCuatrimestres.php', {
          method: 'POST',
          headers: {
...
const cargarGrupos = async () => {
    if (cuatrimestreSeleccionado) {
      try {
        const response = await fetch('http://localhost/WebServices/obtenerGrupos.php', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const cargarResultados = async () => {
    if (grupoSeleccionado) {
      try {
        const response = await fetch('http://localhost/WebServices/buscarCalificaciones.php', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
